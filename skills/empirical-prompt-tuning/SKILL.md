...
Report the target prompt or skill evaluated, scenarios used, iteration results, fixes applied, verification status, and remaining risks. If dispatch was unavailable, say that empirical evaluation was skipped and do not present a self-reread as evidence.
